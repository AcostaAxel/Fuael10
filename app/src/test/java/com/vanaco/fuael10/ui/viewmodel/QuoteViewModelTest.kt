package com.vanaco.fuael10.ui.viewmodel

import androidx.arch.core.executor.testing.InstantTaskExecutorRule
import com.vanaco.fuael10.domain.GetQuotesUseCase
import com.vanaco.fuael10.domain.GetRandomQuoteUseCase
...
internal class QuoteViewModelTest{
    ...
    fun `when viewmodel is created at the first time, get all quotes and set the first value`() = runTest {
        //Given
        val quoteList = listOf(Quote("Buen día", "Axel"), Quote("Buenas tardes", "Acosta"))
    ...
    fun `when randomQuoteUseCase return a quote set on the livedata`() = runTest {
        //Given
        val quote = Quote("Buenas noches", "Axel Acosta")
    ...
    fun `if randomQuoteUseCase return null keep the last value`() = runTest {
        //Given
        val quote = Quote("Buenas", "Axel Ivan")
